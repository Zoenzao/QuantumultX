...
const aqicnToken = '46584db5b0d6707f06455bc276877be267b5a667'

// STEP 2: 参考下方配置片段，在代理工具的配置文件中添加对应的配置。注意：script-response-body 后应该替换为添加 apicnToken 值后的脚本路径
/*
[rewrite_local]
https://weather-data.apple.com/v1/weather/[\w-_]+/[0-9]+\.[0-9]+/[0-9]+\.[0-9]+\? url script-response-body iOS_Weather_AQI_Standard.js
[mitm]
